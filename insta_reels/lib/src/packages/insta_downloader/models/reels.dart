...
//
//     final reels = reelsFromJson(jsonString);

import 'dart:convert';

Reels reelsFromJson(String str) => Reels.fromJson(json.decode(str));

String reelsToJson(Reels data) => json.encode(data.toJson());
